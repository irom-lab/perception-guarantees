...
class Model3DETR(nn.Module):
    ...
    def get_box_predictions(self, query_xyz, point_cloud_dims, box_features):
        ...
        # Box features to return: last layer
        box_features_out = box_features[-1,:,:,:].transpose(1,2)
        ...
        return {
            ...
            "box_features": box_features_out # box features corresponding to last layer of decoder
        }

...
class Go1Env():
    ...
    def reset_task(self, task):
        ...
        self.rgb_cfg = task.observation.rgb # a dictionary?
    ...
    def step(self, action):
        ...
        dist_to_goal_center = np.linalg.norm(self._state[:2] - self._goal_loc) #x,y
    ...
    def init_pb(self):
        ...
        # Coordinates shifted and inverted
        ...
        self.ground_id = p.createMultiBody(
            ...
            basePosition=[self.room_dim / 2, self.room_dim / 2, -self.wall_thickness / 2]
        )
        ...
        self.wall_back_id = p.createMultiBody(
            ...
            basePosition=[-self.wall_thickness / 2, self.room_dim/2, self.wall_height / 2]
        )
        ...
        self.wall_left_id = p.createMultiBody(  # positive in y
            ...
            basePosition=[
                self.room_dim / 2,
                self.room_dim + self.wall_thickness/2,
                self.wall_height / 2
            ],
        ...
        self.wall_front_id = p.createMultiBody(
            ...
            baseVisualShapeIndex=wall_front_visual_id, basePosition=[
                self.room_dim + self.wall_thickness / 2, self.room_dim/2,
                self.wall_height / 2
            ]
        )
        # Getting rid of top wall for better visibility

...
from pc_util import write_bbox, point_cloud_to_bbox, preprocess_point_cloud, write_ply, read_ply, write_oriented_bbox_ply_from_outputs
...
if __name__=='__main__':
    ...
    # Write oriented bbox from outputs
    num_objects = write_oriented_bbox_ply_from_outputs(outputs, "3detr_bboxes.ply", prob_threshold=0.1)
    print(" ")
